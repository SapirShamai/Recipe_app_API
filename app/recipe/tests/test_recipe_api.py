...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_update_user_return_error(self):
        """Test changing the recipe user results en error"""
        new_user = create_user(email='users2@example.com', password='test1234')
        recipe = create_recipe(user=self.user)
    ...
    def test_create_recipe_with_new_tags(self):
        """Test create recipe with a new tags"""
        payload = {
    ...
    def test_create_ingredient_on_update(self):
        """Creating an ingredient when updating a recipe"""
        recipe = create_recipe(user=self.user)
